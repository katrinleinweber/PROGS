#!/usr/bin/gawk -f
#
# NDSPARSE:  parses the contents of NDS daylog file
#
# USAGE: gawk -f ndsparse.awk -f mathlib.awk [Var1,[Var2,...]] [filename] ...
...
# Written: CM Duncombe Rae, somewhat modified from ddsparse.awk
